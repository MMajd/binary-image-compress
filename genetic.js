function Genetic() {
    ...
    $this.drawStats = function () {
        ...
        lowerLeftBuffer.stroke(120);
        lowerLeftBuffer.line(0, lowerLeftBuffer.height/2, 
        	lowerLeftBuffer.width, lowerLeftBuffer.height/2);
        ...
        for (var i = 0; i < $this.history.length; i++) {
            ...
            dist = map($this.history[i].fit*10, 0, 30, 150, 0);
